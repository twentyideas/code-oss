...
import { DevSwarmService, IDevSwarmService } from '../common/devswarm/devswarmService.js';
...
registerSingleton(IDevSwarmService, DevSwarmService, InstantiationType.Eager);
